    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center pt-3">
            <div class="col-md-4 d-grid">
                <a href="/" title="Przejdź na www.hatek.com.pl" class="btn btn-lg btn-green-swipe title-slide-left-anim fw-bold">Przejdź na www.hatek.com.pl <i class="fa fa-angle-right"></i></a>
            </div>
        </div>
