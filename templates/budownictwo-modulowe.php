...
/* Template Name: Budownictwo modułowe */
...
<!-- Slider gallery -->
<section class="slider-gallery py-lg-4 py-lg-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9">
...
<?php if (have_rows('zalety_systemu')) : ?>
    <section class="advantages-system py-4 py-lg-5">
        <h3 class="teko-font text-center mb-3 mb-lg-4 standard-title-4">Zalety modułów:</h3>
