...
/* Template Name: Energooszczędne domy szkieletowe */
...
<section class="d-flex align-items-end top-section-offer mb-3" style="background-image: url('<?php echo $top_bg; ?>')">
    <div class="container">
...
<?php if (have_rows('dlaczego_wybrac')) : ?>
    <section class="advantages-system py-4 py-lg-5">
        <h3 class="teko-font text-center mb-3 mb-lg-4 standard-title-4">Dlaczego wybrac drewniany dom?</h3>
        <div class="container mb-3 mb-lg-5">
            <div class="row justify-content-center">
                <?php
                $counter = 0;
                while (have_rows('dlaczego_wybrac')) : the_row();
